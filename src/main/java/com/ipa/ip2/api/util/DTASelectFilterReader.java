...
import com.ipa.ip2.api.model.ProteinHit;
import com.ipa.ip2.api.util.dtaselect.Peptide;
...
//	DTASelectFilterReader reader = new DTASelectFilterReader("/data/2/rpark/ip2_data/rpark/test4/tiny2_2010_09_29_11_2084/search/projects2013_09_27_14_50137/test/DTASelect-filter.txt");
                ...
                new DTASelectFilterReader("/home/rampuria/data/DTASelect-filter.txt");
...
//        this.reader = new FileReader(fileName);
    ...
    */
    ...
    private void readHeader() throws IOException
    {
        ...
        if(this.dbFileName.startsWith("UniProt"))
...
//		String[] peptideLine;
		...
		Peptide line starts like (*)(int)(M||Y||N)\t
                        ...
                        && !lastLine.startsWith("\tProteins\t"))
                {
                    ...
                    peptide = new Peptide(lastLine, version2, version1);
                    //peptide = new Peptide(strArr, version2, version1);
